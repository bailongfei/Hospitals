...
var year = new CalendarPopup("calendarDiv");//将时间钟的js文件复制给year属性，并接受year对象就成时间钟了
 ...
 <!--
    ...
    window.open ("ji_shi_xin_cheng.htm", "newwindow2", "height=400, width=600, top=100, left=100,toolbar=no, menubar=no, scrollbars=yes, resizable=no, location=no, status=no") 
...
<FORM name="frmEvent" method="post" action="listonemonth.jsp">
  ...
  <TABLE width="95%" border="0" align="center" cellpadding="0" cellspacing="2">
    <TBODY>
      <TR>
        <TD valign="bottom"><IMG src="../../images/arrow_01.gif" height="14" width="14" border="0" align="absmiddle"> <a href="shijian.htm" title="查看今日事件"> <font color=red><b>今天</b></font></a> 是：2006年7月11日 星期二</TD>
  ...
  <TABLE width="95%" border=0 align="center" cellPadding=0 cellSpacing=0>
    <TBODY>
      ...
      <TR>
        ...
        <td class="td_10">&nbsp;</td>
        <td class="td_10">&nbsp;</td>
        <td valign=top class="td_10" title=新增事件和查看该天事件！><a href=shijian.htm?Date=2006-7-1 target=mainFrame>1</a> </td>
      </tr>
      <tr>
        <td valign=top class="td_10" title=新增事件和查看该天事件！><a href=shijian.htm?Date=2006-7-2 target=mainFrame>2</a> </td>
        <td valign=top class="td_10" title=新增事件和查看该天事件！><a href=shijian.htm?Date=2006-7-3 target=mainFrame>3</a> </td>
        <td valign=top class="td_10" title=新增事件和查看该天事件！><a href=shijian4.html?Date=2006-7-4 target=main>4</a> </td>
        <td valign=top class="td_10" title=新增事件和查看该天事件！><a href=shijian5.html?Date=2006-7-5 target=main>5</a> </td>
...
月
          ...
          <input name="Submit22" type="button" class="buttonface" value="查看本周安排" onClick="location.href='zhou_an_pai.htm'">
